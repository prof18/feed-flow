package com.prof18.feedflow.android.accounts.miniflux
...
internal fun MinifluxSyncScreen(
    ...
    val hasLocalSubscriptions by viewModel.hasLocalSubscriptions.collectAsStateWithLifecycle(initialValue = false)
