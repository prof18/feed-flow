...
| Import/export advanced paths | Android, iOS | RG-011 covers import smoke; REG-119 covers invalid OPML; REG-120 covers CSV import/read/bookmark state; REG-139 covers bookmarked article export filter success; REG-140 covers OPML export success | OPML partial-failure reporting, remaining article export filters, and deeper saved-file content validation remain uncovered until fixture/provider data and document-save automation are stable without app changes. |
