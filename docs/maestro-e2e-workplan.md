...
| No-feeds empty-state actions | Android, iOS | RG-001 asserts the empty-state text on first launch; REG-147 covers the NoFeedsBottomSheet fan-out (Add feed, Import and export, Feed Suggestions, Accounts) | No remaining app-owned gaps. |
