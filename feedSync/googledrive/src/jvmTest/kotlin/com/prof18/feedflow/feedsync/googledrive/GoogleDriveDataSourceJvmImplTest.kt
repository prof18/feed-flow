...
class GoogleDriveDataSourceJvmImplTest {
    ...
    @Test
    fun `buildVerificationCodeReceiver uses startup fallback receiver on Windows`() {
        assertIs<StartupFallbackVerificationCodeReceiver>(buildVerificationCodeReceiver(DesktopOS.WINDOWS))
    }
