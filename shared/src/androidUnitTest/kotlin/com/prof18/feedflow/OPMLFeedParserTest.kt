...
class OPMLFeedParserTest {
    ...
    fun `The number of feed in category are correct`() = runTest {
        ...
        val techFeeds = feedSources.filter { it.categoryName == "Tech" }
        val basketFeeds = feedSources.filter { it.categoryName == "Basket" }
        val newsFeeds = feedSources.filter { it.categoryName == "News" }
