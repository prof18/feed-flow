...
class FeedCategoryRepositoryBazquxTest : KoinTestBase() {
    ...
    fun `deleteCategory should call gReaderRepository and delete category`() = runTest(testDispatcher) {
        val category = FeedSourceCategory(id = "user/01234567890123456789/label/TestCategory", title = "TestCategory")
    ...
    fun `updateCategoryName should call gReaderRepository and update name`() = runTest(testDispatcher) {
        ...
        val newCategoryId = "user/01234567890123456789/label/UpdatedCategory"
